...
namespace BaldejFramework.Render
{
    public class Camera
    {
        ...
        // This is simply the aspect ratio of the viewport, used for the projection Matrix4x4.
        ...
        // Get the view Matrix4x4 using the amazing LookAt function described more in depth on the web tutorials
        public Matrix4 GetViewMatrix()
        {
            return Matrix4.LookAt(Position, Position + _front, _up);
        }

        // Get the projection Matrix4x4 using the same method we have used up until this point
        public Matrix4 GetProjectionMatrix()
        {
            return Matrix4.CreatePerspectiveFieldOfView(_fov, AspectRatio, 0.01f, 560f);
        }

        // This function is going to update the direction vertices using some of the math learned in the web tutorials.
        private void UpdateVectors()
        {
            // First, the front Matrix4x4 is calculated using some basic trigonometry.
        ...
        public Dictionary<string, object> Raycast(Vector3 rayDirection)
        {
            BEPUutilities.Vector3 rayFrom = new BEPUutilities.Vector3(Position.X, Position.Y, Position.Z);
